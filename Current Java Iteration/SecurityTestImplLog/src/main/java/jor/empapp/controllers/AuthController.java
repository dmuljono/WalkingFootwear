...
public class AuthController {
	...
	public ResponseEntity<MessageResponse> registerUserDetailed(@Valid @RequestBody Customer c) {
		...
		System.out.println(strRole);
			...
			newCustomer.setPassword(encoder.encode(c.getPassword()));
			newCustomer.setAddress(c.getAddress());
			newCustomer.setPhoneNumber(c.getPhoneNumber());
